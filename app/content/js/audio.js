(function () {
    ...
    function applyEnabled(value, persist = true) {
        ...
        if (persist && window.ClassGameStorage) {
            ClassGameStorage.setAudioEnabled(enabled);
        }
    ...
    function init(options) {
        ...
        enabled = window.ClassGameStorage ? ClassGameStorage.isAudioEnabled() : true;
