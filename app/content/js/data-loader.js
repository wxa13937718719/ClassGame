(function () {
    ...
    async function loadManifest(force = false) {
        ...
        window.CLASSGAME_CHAPTER_MANIFEST = manifestCache;
        window.CLASSGAME_CHAPTERS = window.CLASSGAME_CHAPTERS || {};
    ...
    async function loadChapter(chapterId, force = false) {
        ...
        window.CLASSGAME_CHAPTERS = window.CLASSGAME_CHAPTERS || {};
        window.CLASSGAME_CHAPTERS[chapterId] = chapter;
        return chapter;
    }
    ...
    function clearCache() {
        manifestCache = null;
        chapterCache.clear();
        window.CLASSGAME_CHAPTER_MANIFEST = [];
        window.CLASSGAME_CHAPTERS = {};
    }

    window.ClassGameData = {
        loadManifest,
        loadChapter,
        loadEnabledChapters,
        clearCache
