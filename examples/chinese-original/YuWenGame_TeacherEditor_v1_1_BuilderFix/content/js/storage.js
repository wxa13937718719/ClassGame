(function () {
    ...
    const STORAGE_KEY = "yuwen_game_state_v1";
    const OLD_STORAGE_KEYS = ["yuwen_game_state_v0"];
    const VERSION = 3;
    ...
    function readState() {
        try {
            ...
            // 兼容最早版本的音乐设置。
            const oldMusic = localStorage.getItem("yuwen_music_playing");
    ...
    function exportState() {
        ...
        link.href = url;
        link.download = `YuWenGame学习记录_${stamp}.json`;
