(function () {
    ...
    async function loadManifest(force = false) {
        ...
        window.YUWEN_CHAPTER_MANIFEST = manifestCache;
        window.YUWEN_CHAPTERS = window.YUWEN_CHAPTERS || {};
    ...
    async function loadChapter(chapterId, force = false) {
        ...
        window.YUWEN_CHAPTERS = window.YUWEN_CHAPTERS || {};
        window.YUWEN_CHAPTERS[chapterId] = chapter;
        return chapter;
    }
    ...
    function clearCache() {
        manifestCache = null;
        chapterCache.clear();
        window.YUWEN_CHAPTER_MANIFEST = [];
        window.YUWEN_CHAPTERS = {};
    }
